...
<html>
	...
	<input type="submit" class="save" onclick="save()" value="支付" id="submitAddress"></li>
		...
		<input name="openid" type="hidden" value="${openid}">
		 -->
		 <input name="receiverName" type="hidden" value="张三">
		<input name="regionCode" type="hidden" value="测试省份">
		<input name="cityCode" type="hidden" value="测试代码">
		<input name="countyCode" type="hidden" value="测试">
		<input name="address" type="hidden" value="测试">
		<input name="receiverMobile" type="hidden" value="18721887208">
		<input name="prodID" type="hidden" value="3">
		<input name="prodName" type="hidden" value="百年蔷薇">
		<input name="price" type="hidden" value="23">
		<input name="agentID" type="hidden" value="1">
		<input name="orderCode" type="hidden" value="1446562167454">
		<input name="openId" type="hidden" value="33erj3ri3rljj490j0elll">
